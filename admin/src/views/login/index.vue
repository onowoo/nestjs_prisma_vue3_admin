<template>
  <div class="wh-full flex-col bg-[url(@/assets/images/wavy-lines.svg)] bg-cover">
    <div
      class="m-auto max-w-700 min-w-345 f-c-c border-gray-100/30 rounded-8 border-solid bg-gray-200/30 p-12 backdrop-blur-lg backdrop-filter card-shadow dark:border-gray-100/30 dark:bg-gray-600/30"
    >
